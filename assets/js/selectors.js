...
const PREVIEW_SELECTORS = {
    ...
    PROFILE_PICTURE_PREVIEW: '#kw-mini-web-profile-pic img',
    BACKGROUND_IMAGE_PREVIEW: '#kw-bg-image-preview',
    BACKGROUND_IMAGE_LIVE_PREVIEW: '#kw-mini-web-bg-image',
    BACKGROUND_IMAGE_OVERLAY_TEXT: '.kw-bg-image-text',

    // Live Preview Text Selectors
    LIVE_USER_NAME: '#kw-mini-web-user-name h2',
    LIVE_COMPANY_NAME: '#kw-mini-web-company-name h2',
    LIVE_JOB_TITLE: '#kw-mini-web-job-title h2',
